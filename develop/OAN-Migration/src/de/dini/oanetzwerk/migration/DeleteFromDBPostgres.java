...
public class DeleteFromDBPostgres {
	...
	public static PreparedStatement Formats(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement Identifiers(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement TypeValue(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement Titles(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement Publishers(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement Object2Author(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement Object2Editor(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement Object2Contributor(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement Object2Language(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement Object2Iso639Language(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement Object2Keywords(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement Other_Classification(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement DDC_Classification(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement DNB_Classification(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement DINI_Set_Classification(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement Interpolated_DDC_Classification(Connection connection, BigDecimal object_id) throws SQLException {
	...
	public static PreparedStatement UsageData_Months(Connection connection, BigDecimal object_id, BigDecimal metrics_id,
	...
	public static PreparedStatement UsageData_Overall(Connection connection, BigDecimal object_id, BigDecimal metrics_id)
			throws SQLException {
	...
	public static PreparedStatement Repositories(Connection connection, Long repository_id) throws SQLException {
