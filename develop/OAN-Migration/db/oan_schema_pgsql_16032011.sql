...
"DINI_set_id" numeric(38,0) NOT NULL CONSTRAINT dini_id PRIMARY KEY,
"name" varchar(256) NOT NULL,
...
"duplicate_id" numeric(38,0) NOT NULL,
...
"language_id" numeric(38,0) NOT NULL CONSTRAINT language_id PRIMARY KEY,
...
"language_id" numeric(38,0) NOT NULL CONSTRAINT lang_id PRIMARY KEY,
...
"person_id" numeric(38,0) NOT NULL CONSTRAINT pk_personid PRIMARY KEY,
...
"repository_id" numeric(38,0) NOT NULL CONSTRAINT repository_id PRIMARY KEY,
"name" varchar(256) NOT NULL,
...
"service_id" numeric(38,0) NOT NULL CONSTRAINT service_id PRIMARY KEY,
"name" varchar(256) NOT NULL
)
WITH (OIDS=FALSE);
...
"metrics_id" numeric(38,0) NOT NULL CONSTRAINT metrics_id PRIMARY KEY,
"name" varchar(256) NOT NULL
)
WITH (OIDS=FALSE);
...
"object_id" numeric(38,0) NOT NULL CONSTRAINT object_id PRIMARY KEY,
"repository_id" numeric(38,0) NOT NULL CONSTRAINT repo_id REFERENCES "Repositories"(repository_id),
...
"object_id" numeric(38,0) NOT NULL CONSTRAINT am_oid REFERENCES "Object"(object_id),
"harvested" timestamp NOT NULL,
...
"object_id" numeric(38,0) NOT NULL CONSTRAINT dv_oid REFERENCES "Object"(object_id),
"number" int NOT NULL,
"value" timestamp,
...
"object_id" numeric(38,0) NOT NULL CONSTRAINT ddcbh_oid REFERENCES "Object"(object_id),
...
"object_id" numeric(38,0) NOT NULL CONSTRAINT fk_oid REFERENCES "Object"(object_id),
"DINI_set_id" numeric(38,0) NOT NULL CONSTRAINT fk_dini_set_id REFERENCES "DINI_Set_Categories"("DINI_set_id"),
...
"object_id" numeric(38,0) NOT NULL CONSTRAINT fk_oid REFERENCES "Object"(object_id),
"person_id" numeric(38,0) NOT NULL CONSTRAINT fk_personid REFERENCES "Person"(person_id),
"number" int NOT NULL,
...
"object_id" numeric(38,0) NOT NULL CONSTRAINT fk_oid REFERENCES "Object"(object_id),
"language_id" numeric(38,0) NOT NULL CONSTRAINT fk_languageid REFERENCES "Iso639Language"(language_id),
"number" int NOT NULL,
...
"object_id" numeric(38,0) NOT NULL CONSTRAINT fk_oid REFERENCES "Object"(object_id),
"language_id" numeric(38,0) NOT NULL CONSTRAINT fk_languageid REFERENCES "Language"(language_id),
"number" int NOT NULL,
...
"other_id" numeric(38,0) NOT NULL CONSTRAINT pk_otherid PRIMARY KEY,
"name" varchar(256) NOT NULL
)
WITH (OIDS=FALSE);
...
"object_id" numeric(38,0) NOT NULL CONSTRAINT fk_oid REFERENCES "Object"(object_id),
"other_id" numeric(38,0) NOT NULL CONSTRAINT fk_otherid REFERENCES "Other_Categories"(other_id),
...
"repository_id" numeric(38,0) NOT NULL CONSTRAINT fk_repoid REFERENCES "Repositories"(repository_id)
)
WITH (OIDS=FALSE);
...
"service_id" numeric(38,0) NOT NULL CONSTRAINT fk_serviceid REFERENCES "Services"(service_id),
...
"service_id" numeric(38,0) NOT NULL CONSTRAINT fk_servid REFERENCES "Services"(service_id),
"predecessor_id" numeric(38,0) CONSTRAINT fk_servid2 REFERENCES "Services"(service_id),
...
"type_id" numeric(38,0) NOT NULL CONSTRAINT pk_typeid PRIMARY KEY,
"object_id" numeric(38,0) NOT NULL CONSTRAINT fk_oid REFERENCES "Object"(object_id),
...
"object_id" numeric(38,0),
"metrics_id" numeric(38,0) NOT NULL CONSTRAINT fk_metricsid REFERENCES "UsageData_Metrics"(metrics_id),
...
"workflow_id" numeric(38,0) NOT NULL CONSTRAINT pk_workflowid PRIMARY KEY,
"object_id" numeric(38,0) NOT NULL CONSTRAINT fk_objectid REFERENCES "Object"(object_id),
"service_id" numeric(38,0) NOT NULL CONSTRAINT fk_serviceid REFERENCES "Services"(service_id),
...
"worklist_id" numeric(38,0) NOT NULL CONSTRAINT pk_worklistid PRIMARY KEY,
"object_id" numeric(38,0) NOT NULL CONSTRAINT fk_objectid REFERENCES "Object"(object_id),
"service_id" numeric(38,0) NOT NULL CONSTRAINT fk_serviceid REFERENCES "Services"(service_id),
"time" timestamp NOT NULL
)
