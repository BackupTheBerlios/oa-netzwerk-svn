...
public class SelectFromDBSybase implements SelectFromDB {

	/**
	 * 
	 */

	private Logger logger = Logger.getLogger(SelectFromDBSybase.class);
...
//	 * @throws SQLException
//	 */
//	public PreparedStatement Workflow(Connection connection, BigDecimal predecessor_id, BigDecimal service_id) throws SQLException {
//
//		PreparedStatement preparedstmt = connection
...
//	 * @throws SQLException
//	 */
//	public PreparedStatement WorkflowDBTimeAsString(Connection connection, BigDecimal service_id) throws SQLException {
//
//		PreparedStatement preparedstmt = connection
...
//				System.out.println("Generated Statement ID: " + Integer.toString(ids.size() * x + y));
	 ...
	 * @throws SQLException
	 */
//	public PreparedStatement OAIListSetsbyID(Connection connection, String set, Date from, Date until) throws SQLException {
//
//		boolean aND = false;
//
