...
<f:view>
	...
	<head>
		...
		<title><h:outputText value="#{msg.linkname_projekt} - #{msg.project_name}" /></title>
	</head>
	...
	<h3>Überblick</h3>
	<p><br />
	<img src="../img/Logo_oan_rgb_micro.png" /><br />
	<br />
	</p>
	<p>Das „Open-Access-Netzwerk“ (OA-Netzwerk) zielt auf eine verstärkte Vernetzung von Repositorien, um den deutschen
	Forschungsbeitrag national und international sichtbarer zu machen. Hintergrund ist, dass digitale Sammlungen im
	Hinblick auf Wahrnehmung und Nutzung erst in einer organisatorisch und technisch vernetzten Umgebung ihre optimale
	Wirkung entfalten.</p>
	<p>Initiiert von der Deutschen Initiative für Netzwerkinformation e.V. (DINI), fördert die Deutsche
	Forschungsgemeinschaft (DFG) das Projekt. OA-Netzwerk bildet das Dach des virtuellen Projektverbundes für
	„OA-Statistik“ sowie „OA-Citation“, die zugehörige Dienste wie Nutzungsmessungen und Zitationsanalysen entwickeln
	werden.</p>
