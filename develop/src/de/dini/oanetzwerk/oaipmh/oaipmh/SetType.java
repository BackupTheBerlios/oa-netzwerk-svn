...
public class SetType {
    ...
    @XmlElement(required = true, name="setSpec", namespace="http://www.openarchives.org/OAI/2.0/")
    protected String setSpec;
    @XmlElement(required = true, name="setName", namespace="http://www.openarchives.org/OAI/2.0/")
