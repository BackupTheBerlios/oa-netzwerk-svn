package de.dini.oanetzwerk.oaipmh.oaipmh;
...
public class OAIPMHtype {
    ...
    @XmlElement(required = true, name="responseDate", namespace="http://www.openarchives.org/OAI/2.0/")
    protected XMLGregorianCalendar responseDate;
    @XmlElement(required = true, name="request", namespace="http://www.openarchives.org/OAI/2.0/")
